...
module.exports = {
    ...
    //通用配置
    general: {
	platform:           process.env.platform ? process.env.platform: 5,      //1:安卓手机 2:aPad 3:安卓手表 4:MacOS 5:iPad
        debug:              false,  //开启debug
        ...
        ws_reverse_url:  process.env.ws_reverse_url? JSON.parse(process.env.ws_reverse_url) : [ //反向ws地址，可以添加多个url
